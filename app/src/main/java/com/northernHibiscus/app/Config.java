package com.northernHibiscus.app;
...
public class Config {
    ...
    public static final Object[] TITLES = new String[]{"Northern Hibiscus"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"https://northernhibiscus.com/blog/"};
